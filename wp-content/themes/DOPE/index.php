...
<div id="content">
    ...
    <div class="entry-infos">
	    <h4 class="entry-title">
		    <a href="<?php the_permalink(); ?>" title="<?php printf( __('Permalink to %s', 'your-theme'), the_title_attribute('echo=0') ); ?>" rel="bookmark">
		    	<?php echo doped_title(get_the_title()); ?>
		    </a>
	    </h4>
	    <span class="entry-date">
	    	<abbr class="published" title="<?php the_time('Y-m-d\TH:i:sO') ?>"><?php echo doped_date(get_the_time('j M.')); ?></abbr>
	    </span>
	    <div class="entry-meta">
	       <span class="category"><?php $categories = get_the_category(); echo $categories[0]->cat_name; ?></span>                 
	    </div>
	...
	<div id="nav-below" class="navigation"><?php echo get_next_posts_link("Plus de d'articles");?>
		<span id="articles-loader"></span>
	</div>
		<?php } else { ?>
