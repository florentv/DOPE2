<?php get_header();?>
		...
		<?php while ( have_posts() ) : the_post() ?>
			...
			<div id="post-<?php the_ID(); ?>" class="post-home">
                ...
                <div class="entry-infos">
	                ...
	                <span class="entry-date"><abbr class="published" title="<?php the_time('Y-m-d\TH:i:sO') ?>"><?php the_time( get_option( 'date_format' ) ); ?></abbr>
	                </span>
	                <div class="entry-meta">
	                    <span class="meta-prep meta-prep-author"><?php the_author_posts_link(); ?>
	                    </span>
	...
	<!--Affichage des dernières news + navigation-->
	<?php } else { ?>
		<h2>Aucun résultat pour la recherche '<?php the_search_query(); ?>'</h2>
	<?php } ?>
	</div>
